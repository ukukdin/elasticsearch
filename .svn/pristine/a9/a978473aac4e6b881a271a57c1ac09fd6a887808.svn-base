...
<%
HashMap<String,String> documentOfStatisticsMacAddr  = (HashMap<String,String>)request.getAttribute("documentOfStatisticsMacAddr");
%>
...
<div class="contents-table dataTables_wrapper">
    <table id="tableForListOfMacAddr" class="table table-condensed table-bordered table-hover">
        ...
        for(int i=1;i<=5;i++) {
            ...
            ///////////////////////////////////////////////////////////////////////////////////////
            String count  = (String)documentOfStatisticsMacAddr.get(String.valueOf(i));
