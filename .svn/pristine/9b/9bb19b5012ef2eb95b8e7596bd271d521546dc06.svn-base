...
public class NurierException extends Exception {
    
    private static final long SerialVersionUID = 2401121526017278281L;
    
    private static final Logger Logger = LoggerFactory.getLogger(NurierException.class);
     ...
     */
    public NurierException(Throwable throwable, String errorCode, String debuggingMessage) {
        super(throwable);
        throwable.printStackTrace();
        setMessage(errorCode, debuggingMessage);
    }
    
    public NurierException(Throwable throwable, String errorCode) {
     ...
     */
    public NurierException(String errorCode, String debuggingMessage) {
        setMessage(errorCode, debuggingMessage);
    }
    
    public NurierException(String errorCode) {
        this(errorCode, "");
    }
