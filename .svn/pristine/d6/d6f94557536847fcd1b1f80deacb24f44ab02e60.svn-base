...
<form name="formForListOfMacAddr" id="formForListOfMacAddr" method="post">
...
<div class="row" style="margin-bottom:1px;">
    ...
    <div class="col-sm-6">
        <div class="pull-right">
            <button type="button" id="buttonForMacAddrSearch"         class="btn btn-red"                                                              >검색</button>
        </div>
    </div>
</div>

<div id="divForListOfMacAddr"></div>


<script type="text/javascript">
<%-- 통계 - 최신 단말기 목록 출력처리 (yhshin) --%>
function showListOfMacAddr() {
    ...
    jQuery("#formForListOfMacAddr").ajaxSubmit({
        url          : "<%=contextPath %>/servlet/nfds/setting/cache_store/list_of_recent_access_mac_addr.fds",
        target       : "#divForListOfMacAddr",
        type         : "post",
...
//button click event
//////////////////////////////////////////////////////////////////////////////////
<%-- 통계 - 최신 단말기 '검색' 버튼 클릭에 대한 처리 (yhshin) --%>
jQuery("#buttonForMacAddrSearch").bind("click", function() {
    showListOfMacAddr(); <%-- 통계 - 최신 단말기 출력처리 --%>
});

<%-- 통계 - 최신 단말기 '검색' 기능 처리 (yhshin) --%>
