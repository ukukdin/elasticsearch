    ...
    <table id="tableForSearch" class="table table-bordered datatable">
        ...
        <tbody>
            <tr>
                ...
                <th>요청사무소</th>
                <td>
                    <input type="text" name="branchOfficeForSearching"    id="branchOfficeForSearching"     class="form-control" maxlength="25" />
                </td>
            </tr>
...
function showListOfWhiteUsers() {
    var defaultOptions = {
            url          : "<%=contextPath %>/scraping/setting/white_list_management/list_of_white_users.fds",
...
function openModalForFormOfWhiteUser(mode) {
    ...
    var defaultOptions = {
            url          : "<%=contextPath %>/scraping/setting/white_list_management/form_of_white_user.fds",
...
jQuery("#buttonForWhiteUserExcelDownload").bind("click", function() {
    ...
    form.action = "<%=contextPath %>/servlet/nfds/setting/white_list_management/excel_white_list.xls";
    form.submit();
});
//////////////////////////////////////////////////////////////////////////////////
</script>
