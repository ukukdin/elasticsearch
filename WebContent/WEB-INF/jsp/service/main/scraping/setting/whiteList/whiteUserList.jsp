...
<div class="contents-table dataTables_wrapper" style="/* min-height:500px; */">
    ...
    <colgroup>
        ...
        <col style="width:10%;" /><%-- value 구분     --%>
        <col style="width:15%;" /><%-- value          --%>
        <col style="width:15%;" /><%-- 이용자명       --%>
        <!-- <col style="width:10%;" /> --><%-- 요청사무소             --%>
        <col style="width:10%;" /><%-- 등록일시       --%>        
        <col style="width:10%;" /><%-- 수정일시       --%>        
    ...
    for(HashMap<String,String> whiteUser : listOfWhiteUsers) {
        ...
        String type               = StringEscapeUtils.escapeHtml4(StringUtils.trimToEmpty((String)whiteUser.get("TYPE")));
        String value              = StringEscapeUtils.escapeHtml4(StringUtils.trimToEmpty((String)whiteUser.get("VALUE")));
        String userName           = StringEscapeUtils.escapeHtml4(StringUtils.trimToEmpty((String)whiteUser.get("NAME")));
        ...
        %>
        <tr>
            <td style="text-align:center;" ><%=rowNumber %>&nbsp;                                 </td>  <%-- rowNum   --%>
            <td style="text-align:center;"><%=type %>                                             </td>  <%-- type     --%>
            <td style="text-align:center;"><%=value %>                                            </td>  <%-- value    --%>
            <td style="text-align:center;"><%=userName %>                                         </td>  <%-- 이용자명 --%>
