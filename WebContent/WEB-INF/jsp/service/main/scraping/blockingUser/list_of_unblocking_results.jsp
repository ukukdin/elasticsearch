...
<div class="contents-table dataTables_wrapper">
    ...
    if ( listOfResult != null && listOfResult.size() > 0 ) {
        for(Map<String,Object> result : listOfResult) {
            ...
            String date         = StringUtils.trimToEmpty((String)result.get(CommonConstants.KEY_UNBLOCKING_DATE));
            String ip           = StringUtils.trimToEmpty((String)result.get(CommonConstants.KEY_UNBLOCKING_IP));
            String type         = StringUtils.trimToEmpty((String)result.get(CommonConstants.KEY_UNBLOCKING_TYPE));
            String clientID     = StringUtils.trimToEmpty((String)result.get(CommonConstants.KEY_UNBLOCKING_CLIENTID));
            %>
            <tr>
                <td><%=date          %></td>
                <td><%=ip            %></td>
...
<form name="formForDetail" id="formForDetail" method="post">
